...
This repository implements the Single-page design portfolio from the approved design source. Agents working here must preserve design fidelity, accessibility, maintainability, and traceability between Figma, implementation, Git history, and deployments.
...
- Figma design: `https://www.figma.com/design/HfvHWLtq8ESeaaVpAU6IlX/single-page-design-portfolio?node-id=2141-862`
- Primary Figma page: `🤖 Workflow` (`2141:862`)
- Vercel team: `fer-falcons-team`
- Vercel project: `single-page-design-portfolio`
